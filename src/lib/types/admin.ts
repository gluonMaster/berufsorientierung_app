...
export type ActivityLogActionType =
	...
	// Действия с отзывами
	| 'review_create' // Создание отзыва авторизованным пользователем
	| 'review_create_public' // Создание отзыва через публичную ссылку
	| 'review_approve' // Одобрение отзыва модератором
	| 'review_reject' // Отклонение отзыва модератором
	| 'review_public_link_create' // Создание публичной ссылки для отзывов
